...
const CreateLabTestForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <nav className="bg-gray-200 text-black shadow-md py-4">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          <h1 className="text-xl font-bold">Lab Tests Manager</h1> <br/>
          <nav className="space-x-2">
          <button onClick={()=> navigate('/admindashboard')} className="text-blue-500 font-semibold">Dashboard
            <span className="text-gray-500 ">/</span>
          </button>
          <button onClick={()=> navigate('/labs-list')} className="text-blue-500 font-semibold">All Labs Test
            <span className="text-gray-500">/</span>
          </button>
          <button onClick={()=> navigate('/labs-create')} className="text-gray-500 font-semibold">Create Lab Tests</button>
